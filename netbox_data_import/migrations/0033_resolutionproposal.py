...
class Migration(migrations.Migration):
    dependencies = [
        # No core node of its own: 0027 already pins `core.0024_job_notifications`, which provides
        # ObjectType and which this descends from. `makemigrations` pins the newest node the
        # generating machine has, and NetBox 4.6.10 ships no core migration past 0024.
